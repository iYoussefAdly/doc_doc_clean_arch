...
abstract class SearchRepo {
  Future<Either<Failure, List<DoctorEntity>>> getSearchResults({required SearchParam param});
  Future<Either<Failure, List<DoctorEntity>>> sortDoctors({required SortParam param});
}
